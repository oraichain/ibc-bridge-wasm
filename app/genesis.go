...
func NewDefaultGenesisState(cdc codec.JSONMarshaler) GenesisState {
	...
	stakingGenesis.Params.BondDenom = Bech32Prefix
	...
	mintGenesis.Params.MintDenom = Bech32Prefix
	govGenesis.DepositParams.MinDeposit = sdk.NewCoins(sdk.NewCoin(Bech32Prefix, sdk.TokensFromConsensusPower(10)))
	// TODO: testing
	govGenesis.VotingParams.VotingPeriod = time.Minute * 2 // test for 10 mins voting period
	crisisGenesis.ConstantFee = sdk.NewCoin(Bech32Prefix, sdk.TokensFromConsensusPower(10))
